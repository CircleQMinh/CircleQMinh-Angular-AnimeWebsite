...
export class SearchService {
  ...
  getSearchResultStatusTypeGenre(status:string,type:string,genre:string,page:number,order_by:string):Observable<any>{
  ...
  getSearchResultYearSeason(year:string,season:string):Observable<any>{
  ...
  getSearchResultLetter(letter:string,page:number):Observable<any>{
